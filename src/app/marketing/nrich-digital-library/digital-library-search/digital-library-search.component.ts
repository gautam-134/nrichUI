...
@Component({
  selector: 'app-digital-library-search',
  standalone: true,
  imports: [],
  templateUrl: './digital-library-search.component.html',
  styleUrl: './digital-library-search.component.scss'
})
export class DigitalLibrarySearchComponent implements OnInit {
